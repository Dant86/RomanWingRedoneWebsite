...
extern char* CreateUser(GoString p0, GoString p1, GoString p2, GoString p3);

extern char* GetUser(GoInt p0);

extern char* GetUserByEmail(GoString p0);

extern char* ValidateUser(GoInt p0, GoString p1);

extern char* CreateArticle(GoInt p0, GoString p1, GoString p2, GoString p3, GoString p4);
...
extern char* CreateEvent(GoString p0, GoString p1, GoString p2, GoString p3);
